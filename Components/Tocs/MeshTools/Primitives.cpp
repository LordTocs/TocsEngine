...
namespace MeshTools {
	...
	Rendering::Mesh Primitives::BuildCube()
	{
		MeshBuilder<Rendering::PositionTextureNormal> CubeBuilder;
...
FirstUseStatic<Rendering::Mesh, Primitives::BuildCube> Primitives::Cube;
