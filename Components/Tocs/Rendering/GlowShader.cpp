...
Pipe &GlowShader::GetPipe(RenderSystem &system) const
{
	return system.Pipes.GlowPipe;
}

void GlowShader::QueueJob(JobProxy &proxy, RenderSystem &system, Graphics::ShaderState &inputs) const
{
